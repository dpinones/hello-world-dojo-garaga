...
let modulus = modulus;
    ...
    // Prefill constants:
            ...
            circuit_inputs = circuit_inputs.next_span(HONK_SUMCHECK_SIZE_13_PUB_18_GRUMPKIN_CONSTANTS.span()); // in0 - in26
...
let modulus = modulus;
    ...
    let mut circuit_inputs = (t24,t28,t32,t36,t40,t44,t48,t52,t56,t60,t64,t68,t72,t76,t80,t84,t88,t92,t96,t100,t104,t108,t112,t116,t120,t124,t128,t496,t497,t498,t499,t500,t152,t156,t160,t326,t341,t356,t371,t386,t401,t416,t431,t446,t461,t476,t491,t495,).new_inputs();
    // Prefill constants:
...
circuit_inputs = circuit_inputs.next_2(coeff); // in2
        ...
        let outputs = circuit_inputs.done_2().eval(modulus).unwrap();
let res:u384 = outputs.get_output(t426);return (res,);
}
