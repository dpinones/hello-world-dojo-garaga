...
build-circuit-wolf:
	cd circuits/is_wolf && nargo build

build-circuit-kill:
	cd circuits/kill_sheep && nargo build
...
gen-vk-wolf:
	bb write_vk --scheme ultra_honk --oracle_hash keccak -b ./circuits/is_wolf/target/is_wolf.json -o ./circuits/is_wolf/target

gen-vk-kill:
	bb write_vk --scheme ultra_honk --oracle_hash keccak -b ./circuits/kill_sheep/target/kill_sheep.json -o ./circuits/kill_sheep/target

gen-verifier-wolf:
	garaga gen --system ultra_keccak_honk --vk circuits/is_wolf/target/vk --project-name verifier_is_wolf

gen-verifier-kill:
	garaga gen --system ultra_keccak_honk --vk circuits/kill_sheep/target/vk --project-name verifier_kill_sheep

gen-verifier:
	garaga gen --system ultra_keccak_honk --vk ../circuit/target/vk --project-name verifier
