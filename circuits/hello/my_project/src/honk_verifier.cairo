use super::honk_verifier_circuits::{
    run_BN254_EVAL_FN_CHALLENGE_SING_47P_RLC_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_7_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_7_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_7_circuit,
    run_GRUMPKIN_ZK_HONK_PREP_MSM_SCALARS_SIZE_7_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_7_PUB_1_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        precomputed_lines, run_BN254_EVAL_FN_CHALLENGE_SING_47P_RLC_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_7_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_7_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_7_circuit,
        run_GRUMPKIN_ZK_HONK_PREP_MSM_SCALARS_SIZE_7_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_7_PUB_1_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_7_PUB_1_circuit(
            ...
            let (vanishing_check, diff_check) = run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_7_circuit(
            ...
            full_proof.msm_hint_batched.RLCSumDlogDiv.validate_degrees_batched(47);
            ...
            let (lhs_fA0) = run_BN254_EVAL_FN_CHALLENGE_SING_47P_RLC_circuit(
                A: random_point,
                coeff: mb.coeff0,
                SumDlogDivBatched: full_proof.msm_hint_batched.RLCSumDlogDiv,
            );
            let (lhs_fA2) = run_BN254_EVAL_FN_CHALLENGE_SING_47P_RLC_circuit(
