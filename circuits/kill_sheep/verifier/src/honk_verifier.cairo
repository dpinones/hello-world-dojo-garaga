...
use super::honk_verifier_circuits::{run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_18_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_12_circuit, run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit, is_on_curve_bn254};
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{vk, VK_HASH, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_18_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_12_circuit, run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit, is_on_curve_bn254};
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_12_PUB_18_circuit(
...
full_proof.proof.lookup_read_tags.into(), // Proof point 8
            ...
            let (lhs_fA0) = run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit(A:random_point, coeff:mb.coeff0, SumDlogDivBatched:full_proof.msm_hint_batched.RLCSumDlogDiv, modulus:mod_bn);
            let (lhs_fA2) = run_BN254_EVAL_FN_CHALLENGE_SING_48P_RLC_circuit(A:G1Point{x:mb.x_A2, y:mb.y_A2}, coeff:mb.coeff2, SumDlogDivBatched:full_proof.msm_hint_batched.RLCSumDlogDiv, modulus:mod_bn);
